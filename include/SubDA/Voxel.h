...
class Voxel{
 protected:
  ...
  std::vector<InOutClassifier> m_inOutClassifier;
 ...
 public:
  ...
  void addObject(const InOutClassifier&  classifier);
  ...
  inline const std::vector<InOutClassifier> & getFunction() const{
    return m_inOutClassifier;
  }
