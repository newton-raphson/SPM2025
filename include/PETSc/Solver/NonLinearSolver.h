...
class NonlinearSolver : public Solver {
 ...
 public:
  NonlinearSolver(DA* da,feMat<DIM> * mat, feVec<DIM> * vec,const DistTREE & dtree, const Point<DIM> & domainMin,const Point<DIM> & domainMax, const DENDRITE_UINT dof, const bool mfree, const bool skipBCApplication,const bool oneShotMatrixAssembly);
