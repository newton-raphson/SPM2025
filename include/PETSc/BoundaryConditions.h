...
namespace PETSc{
    ...
    #ifdef IBM
        const std::vector<PetscInt> * ibmDirichletNodes_ = nullptr;
         std::vector<PetscInt>  sbmDirichletNodes_;
        bool isAllocatedsbmNodes = false;
    #endif
...
//        PetscErrorCode applyVecIBMBC(ot::DA<DIM>* da, Vec rhs, const std::vector<PetscInt> * dirichletNodeIDs);
        ...
        PetscErrorCode applySBMBoundaryCondition(DA* da, Mat mat);
