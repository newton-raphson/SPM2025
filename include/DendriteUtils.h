 ...
 **/
void dendrite_init(int argc, char **argv, int maxDepth = 30);
 ...
 * @return regular DA.
 */
ot::DA<DIM> * createRegularDA(std::vector<ot::TreeNode<DENDRITE_UINT, DIM>> & treePart,const DENDRITE_UINT level, const  DENDRITE_UINT eleOrder);
...
DA * createSubDA(DistTREE & distTREE,const PhysicalDomainDecider & funtion, const DENDRITE_UINT level, const DENDRITE_UINT eleOrder,const double sfcTol = 0.001);
/**
