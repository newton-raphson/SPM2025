...
//
// Created by Cheng-Hau // modified by Samundra
//
//// We want to just compute the error in the region inside the true boundary
//// basically, want to also return the elemental error so it becomes easy to \
/// visualize the errors and where it is dominant
