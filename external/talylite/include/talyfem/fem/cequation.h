 ...
 */
    ...
    public:
        ...
        */
        virtual void Integrands4side_be(const TALYFEMLIB::FEMElm &fe, const unsigned int side_idx, const unsigned int id, TALYFEMLIB::ZEROARRAY<double> &be, const double * h) {
         ...
         * @param [out] Ae the element matrix to put data in
        */
        virtual void Integrands4side_Ae(const TALYFEMLIB::FEMElm &fe, const unsigned int side_idx, const unsigned int id, TALYFEMLIB::ZeroMatrix<double> &Ae,const double * h) {
            throw TALYFEMLIB::TALYException() << "[ERROR] : Something is wring in your implementation \n You need to implement the Integrands4Side_Ae" ;
        }

        virtual void Integrands_Ae(const TALYFEMLIB::FEMElm & fe, TALYFEMLIB::ZEROMATRIX<double> & Ae, const double *h){
          throw TALYFEMLIB::TALYException() << "[ERROR] : Something is wring in your implementation \n You are calling the function to implement Ae via Gauss point, which is not implemented" ;
        }

      virtual void Integrands_be(const TALYFEMLIB::FEMElm & fe, TALYFEMLIB::ZEROARRAY<double> & be, const double *h){
        throw TALYFEMLIB::TALYException() << "[ERROR] : Something is wring in your implementation \n You are calling the function to implement be via Gauss point, which is not implemented" ;
      }

      virtual void computeMat(double * mat, const double * values, const double *h, const int localElemID){
        throw TALYFEMLIB::TALYException() << "[ERROR] : Something is wring in your implementation \n You are calling the function to implement matrix via Tensor Assembly, which is not implemented" ;
      }
      virtual void computeVec(double * out, const double * values, const double *h, const int localElemID){
        throw TALYFEMLIB::TALYException() << "[ERROR] : Something is wring in your implementation \n You are calling the function to implement vector via Tensor Assembly, which is not implemented" ;
      }
