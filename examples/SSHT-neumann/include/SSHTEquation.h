...
class ADEquation : public TALYFEMLIB::CEquation<SSHTNodeData> {
 public:
  ...
  void Integrands4side_Ae(const TALYFEMLIB::FEMElm &fe, const DENDRITE_UINT side_idx, const DENDRITE_UINT id,
                          TALYFEMLIB::ZeroMatrix<double> &Ae, const double *h) override {

  }

  void Integrands4side_be(const TALYFEMLIB::FEMElm &fe, const DENDRITE_UINT side_idx, const DENDRITE_UINT id,
                          TALYFEMLIB::ZEROARRAY<double> &be, const double *h) override {
