...
//    subDomain.addObject(circle);
    ...
    DA * octDA = createSubDA(distTree,functionToRetain,inputData.meshDef.baseLevel,inputData.basisFunction,0.3);
...
#endif
    petscVectopvtu(octDA, distTree.getTreePartFiltered(), nsSolver->getCurrentSolution(), "ns_init", varname, domainExtents, false, false,
                   NSNodeData::NS_DOF);
    ...
    petscVectopvtu(octDA, distTree.getTreePartFiltered(), nsSolver->getCurrentSolution(), "ns", varname, domainExtents, false, false,
                   NSNodeData::NS_DOF);
