...
//    subDomain.finalize(octDA, distTree.getTreePartFiltered(), domain);
    ...
    IO::writeBoundaryElements(octDA, distTree.getTreePartFiltered(), "test", "test",domain);
...
/// -------------------------------------------------------------------------------------------------------------------
    ...
    petscVectopvtu(octDA, treePart, nsSolver->getCurrentSolution(), "solution","ns", varname, domain, false, false,
                   NSNodeData::NS_DOF);
